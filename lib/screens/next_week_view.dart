...
class NextWeekView extends StatefulWidget {
  final nextWeekEventData;
  const NextWeekView({super.key, this.nextWeekEventData});

  @override
  State<NextWeekView> createState() => _NextWeekViewState();
}
...
class _NextWeekViewState extends State<NextWeekView> {
  ...
  //   nextWeekEventData = nextWeekEventData!.sublist(0, nextWeekEventData!.length >=10 ? 10 : nextWeekEventData!.length);
  //   setState(() {});
  // }
    ...
    return
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final productData = widget.nextWeekEventData![index];
