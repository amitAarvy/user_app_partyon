...
class BrowseLiveBandsEventsList extends StatefulWidget {
  const BrowseLiveBandsEventsList({super.key});

  @override
  State<BrowseLiveBandsEventsList> createState() => _BrowseLiveBandsEventsListState();
}
...
class _BrowseLiveBandsEventsListState extends State<BrowseLiveBandsEventsList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text("Live Band Events", style: TextStyle(fontSize: 19)),
        centerTitle: true,
      ),
      body: SafeArea(
