...
class _PopularTechnoListState extends State<PopularTechnoList> {
  ...
  void fetchTechnoListEventData() async {
    QuerySnapshot data = await FirebaseFirestore.instance.collection('Events').where('genre', isEqualTo: widget.type != null ? widget.type : 'Techno').where('isActive', isEqualTo: true).get();
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: isFolded ? 13.0.sp : 21.0.sp,
                                      color: Colors.white,
                                    ),
                                  ...
                                  Text(
                                    ...
                                    overflow: TextOverflow.ellipsis,
                                    style: TextStyle(
                                      fontSize: isFolded ? 18.0.sp : 24.0.sp,
                                      color: Colors.white,
