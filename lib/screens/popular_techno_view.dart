...
//
// class PoputerTechnoView extends StatelessWidget {
//   const PoputerTechnoView({super.key});
//
//
//   @override
...
class PoputerTechnoView extends StatefulWidget {
  final technoEventData;
  const PoputerTechnoView({super.key, this.technoEventData});

  @override
  State<PoputerTechnoView> createState() => _PoputerTechnoViewState();
}
...
class _PoputerTechnoViewState extends State<PoputerTechnoView> {
  ...
  //       .get();
  //   technoEventData = data.docs;
  //   if(hc.city =='All City'){
  //     technoEventData = data.docs.where((element) {
  ...
  //   }
  //
  //   technoEventData = technoEventData!.where((element) => element['date'].toDate().isAfter(today)).toList();
  //   technoEventData!.sort((a, b) => a['date'].toDate().compareTo(b['date'].toDate()));
  ...
  Widget build(BuildContext context) {
    return
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final productData = widget.technoEventData![index];
