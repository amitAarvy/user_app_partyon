...
class _CategoryOnEventState extends State<CategoryOnEvent> {
  ...
  void fetchTechnoListEventData() async {
    QuerySnapshot clubsData = await FirebaseFirestore.instance.collection('Club').where('activeStatus', isEqualTo: true).get();
                                        ...
                                        return Column(
                                          children: [
                                            Text(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              style: TextStyle(fontSize: isFolded ? 14.sp : 42.sp, color: Colors.white, overflow: TextOverflow.ellipsis),
