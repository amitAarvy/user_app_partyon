...
class _HomeViewState extends State<HomeView> {
  ...
  void fetchUpcomingMonthEventData() async{
    ...
    DateTime weekEnds = weekStart.add(Duration(days: 6));
    upcomingMonthData = upcomingMonthData.where((element) => element['date'].toDate().isAfter(weekEnds)).toList();
