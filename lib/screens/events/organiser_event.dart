...
class _OrganiserEventState extends State<OrganiserEvent> {
  ...
  void fetchUpcomingMonthEventData() async{
    ...
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        .collection('Follow')
        .where('uid', isEqualTo: widget.clubUid)
        .get();
            ...
            return SingleChildScrollView(
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: ClipRRect(
                                ...
                                CachedNetworkImage(
                                  ...
                                  placeholder: (_, __) => const Center(
                                    ...
                                    :
                                Image.asset('assets/artist.png',fit: BoxFit.fill,)
                              // kIsWeb?
                          ...
                          Row(
                            ...
                            children: [
                              Text('${widget.clubName}',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w800,color: Colors.white),),
                              ValueListenableBuilder(
                                 ...
                                 GestureDetector(
                                   ...
                                   child: Container(
                                    ...
                                    child: Text(isCheck?'Followed':'Follow',style: TextStyle(fontSize: 12,fontWeight: FontWeight.w800,color: Colors.white),),
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () async {
                        ...
                        if(kIsWeb){
                          print('web is on ');
                          Get.to(()=>BookEvents(clubUID: upcomingMonthData[index]['clubUID'] ?? '', eventID: upcomingMonthData[index].id,
                          ));
                        }else{
                          Get.to(BookEvents(clubUID: upcomingMonthData[index]['clubUID'] ?? '', eventID: upcomingMonthData[index].id,
                          ));
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(DateFormat.yMMMd().format( upcomingMonthData[index]['startTime'] != null
                                      ?  upcomingMonthData[index]['startTime'].toDate()
                                      : DateTime.now(),),style: TextStyle(fontWeight: FontWeight.w800,color: Colors.white),),
                                  Text( upcomingMonthData[index]['title'].toString(),style: TextStyle(fontWeight: FontWeight.w800,color: Colors.grey,fontSize: 13),),
                ...
                if(upcomingMonthData.isEmpty)
                  SizedBox(height: 200,),
                if(upcomingMonthData.isEmpty)
               Center(child: const Text('No event available',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white),))
              ],
                        ),
            );
          },
