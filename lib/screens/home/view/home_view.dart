...
class _HomeViewState extends State<HomeView> {
  ...
  void fetchTechnoListEventData() async {
    QuerySnapshot data = await FirebaseFirestore.instance.collection('Events').where('genre', isEqualTo: 'Techno').where('isActive', isEqualTo: true).get();
    QuerySnapshot clubData = await FirebaseFirestore.instance.collection("Club").where("businessCategory", isEqualTo: 1).get();
  ...
  void fetchThisWeekEventData() async {
    ...
    thisWeekEventData = thisWeekEventData.where(
      (element) {
  ...
  void getGlobalDetail() async {
    QuerySnapshot data = await FirebaseFirestore.instance.collection('globalSettings').get();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (thisWeekEventData.isNotEmpty) ...[
                            ...
                            thisWeekView(
                              thisWeekEventData: thisWeekEventData,
                            ),
                          ],
                          Padding(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        technoUi('assets/techno.png', callBack: () {
                                          Get.to(() => const PopularTechnoList());
                                        }),
                                        ...
                                        technoUi('assets/liveBands.png', callBack: () {
                                          Get.to(() => BrowseLiveBandsEventsList());
                                        }),
                                      ],
                                    ),
                                    SizedBox(height: 10),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        technoUi('assets/commerical.png', callBack: () {
                                          Get.to(() => const PopularCommercialList());
                                        }),
                          ...
                          if (liveBandsEventData.isNotEmpty)
                            BrowseLiveBandsEventsView(
                              liveBandsEventData: liveBandsEventData,
                            ),
                          ...
                          //         ),
                          //         PoputerTechnoView(
                          //           technoEventData: popularTechnoData,
                          //         ),
                          //       ],
                          //     ),
                          //   ).marginAll(10.0),
                          ...
                          if (upcomingMonthData.isNotEmpty) ...[
                            ...
                            Padding(
                                ...
                                child: UpcomingMonthView(
                                  upcomingMonthEventData: upcomingMonthData,
                                )),
                          ],
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  PoputerBollywoodView(
                                    popularCommercialData: popularCommercialData,
                                  ),
                                ],
                              ),
                            ).marginAll(10.0),
                          ...
                          SizedBox(height: 10.h),
                          Padding(padding: EdgeInsets.only(left: 14.w), child: FlashSaleWidget()),
                        ],
                      ),
                    ),
                  ),
...
Widget technoUi(String path, {VoidCallback? callBack}) {
  return GestureDetector(
    onTap: callBack,
    child: Container(height: 110, width: 110, decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(11)), image: DecorationImage(image: AssetImage(path)))),
  );
}
